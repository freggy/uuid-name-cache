 ...
 *
 * <p>Resolves a {@link UUID} to a name of a Minecraft player. The result of this operation will be
    ...
    return this.execute(
        result -> {
          ...
          if (mapping.getName() != null)
            this.cache.nameToUuid.asMap().putIfAbsent(mapping.getName(), mapping);
          return mapping;
        },
        this.QUERY,
        key.toString());
