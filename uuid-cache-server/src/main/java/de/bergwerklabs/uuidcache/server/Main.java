 ...
 *
 * <p>Main class for UUID Cache server.
 *
 * @author Yannic Rieger
 */
public class Main {

  private static final AtlantisPackageService SERVICE =
      new AtlantisPackageService(
  ...
  public static void main(String[] args) {
    ...
    SERVICE.addListener(
        ...
        packet -> {
          ...
          // Since we know the player is online, it is very likely that their name or uuid will be
          // requested
          // so we add them directly to the cache to increase performance because we don't need to
          // access the
          // database.
