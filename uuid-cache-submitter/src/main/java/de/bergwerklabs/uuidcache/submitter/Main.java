...
public class Main extends Plugin implements Listener {
    ...
    private final String INSERT_QUERY = "INSERT INTO uuidcache (uuid, display_name, last_login, last_update) VALUES " +
    ...
    public void onPlayerPostLogin(PostLoginEvent event) {
        ...
        this.getProxy().getScheduler().runAsync(this, () -> {
            try (Statement statement = this.database.prepareStatement(this.INSERT_QUERY)) {
                ...
                // Set last update to the current timestamp because this is the latest data we have from them.
